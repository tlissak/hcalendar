...
del /Q SetupFiles\chrome\
zip.exe
del /Q SetupFiles\chrome\create_hcalendar.jar.cmd

copy zip.exe SetupFiles
chdir SetupFiles
zip.exe -r hcalendar1.0.5.15-fx+fl+mz+ns+tb.xpi *.* -x *.exe
chdir ..

dir SetupFiles\hcalendar1.0.5.15-fx+fl+mz+ns+tb.xpi
xcopy /Y SetupFiles\hcalendar1.0.5.15-fx+fl+mz+ns+tb.xpi .\
pause
